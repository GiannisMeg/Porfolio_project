...
export default function TwitCard1() {
	return (
		<Card
			sx={{
				width: 250,
		...
		>
			<CardContent>
				<Typography
					...
					gutterBottom
				>
					Emailing with @Drizly customer service to increase the tip for
					the wonderful driver that had to deal with my face mask and my
					“there’s a huge spider at the door” screams. Bottles delivered
					and spider removed. I am calmed. A KING. 😂
				</Typography>
